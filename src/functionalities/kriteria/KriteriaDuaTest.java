...
public class KriteriaDuaTest {

	@Test(priority = 25, dependsOnGroups = { "login_group" })
	public void accessKriteria2Page() throws InterruptedException {
	...
	@Test(priority = 26, dependsOnGroups = { "login_group" })
	public void printKriteria2Page() {
	...
	@Test(priority = 27, dependsOnGroups = { "login_group" })
	public void detailKriteria2Page() throws InterruptedException {
	...
	@Test(priority = 28, dependsOnGroups = { "login_group" })
	public void updateKriteria2WithEmptyInput() throws InterruptedException {
	...
	@Test(priority = 29, dependsOnGroups = { "login_group" })
	public void updateKriteria2WithInvalidInput() throws InterruptedException {
	...
	@Test(priority = 30, dependsOnGroups = { "login_group" })
	public void updateKriteria2WithValidInput() throws InterruptedException {
	...
	@Test(priority = 31, dependsOnGroups = { "login_group" })
	...
	@Test(priority = 32, dependsOnGroups = { "login_group" })
