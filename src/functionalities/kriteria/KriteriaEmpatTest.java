...
public class KriteriaEmpatTest {
	@Test(priority = 41, dependsOnGroups = { "login_group" })
	public void accessKriteria4Page() throws InterruptedException {
	...
	@Test(priority = 42, dependsOnGroups = { "login_group" })
	public void printKriteria4Page() {
	...
	@Test(priority = 43, dependsOnGroups = { "login_group" })
	public void detailKriteria4Page() throws InterruptedException {
	...
	@Test(priority = 44, dependsOnGroups = { "login_group" })
	public void updateKriteria4WithEmptyInput() throws InterruptedException {
	...
	@Test(priority = 45, dependsOnGroups = { "login_group" })
	public void updateKriteria4WithInvalidInput() throws InterruptedException {
	...
	@Test(priority = 46, dependsOnGroups = { "login_group" })
	public void updateKriteria4WithValidInput() throws InterruptedException {
	...
	@Test(priority = 47, dependsOnGroups = { "login_group" })
	...
	@Test(priority = 48, dependsOnGroups = { "login_group" })
